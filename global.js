...
$(".characters").click(function () {
    ...
    for (const ch of character) {
        ...
        if (thisChar.id === "charPen2" && character[6].firstTalk) {
            console.log('Penelope was talked to with scraps!');
            dia = character[6].diaOptions();
            diaSplit(dia, () => {
                removeItem('paperScrap');
                character[6].firstTalk = false;
        ...
        if (thisChar.id === "charMon") {
            ...
            setTimeout(() => {
                ...
                $(".diaButton").addClass("disabled");
                $(".invItems").addClass("disabled");
            ...
            setTimeout(() => {
                ...
                $(".diaButton").removeClass("disabled");
                errorSound.volume = .0;
                badOmenTrigger = true;
