    ...
    addEnvelope: function () {
      for (t in $(".invItems")) {
        ...
        if (!$(this).hasClass("hide")) {
          ...
          $("#" + invCount).append(
            "<img width= '70px' src='images/objects/envelope.png' />",
          );
  ...
  },
  {
    ...
    diaOptions: function () {
      ...
      if (this.firstTalk == true) {
        console.log("First time you've met this character?" + this.firstTalk);
        dia =
          "???: …What? You need something?_Carter: Not really… though I guess…what’s your opinion on this situation?_???:  I don’t really care. All I know is we’re dead in the water. They can keep saying it’s “navigational issues,” but that’s a load of shit._Carter: At least someone around here’s singing my tune...";
        return dia;
      } else {
        console.log("First time you've met this character?" + this.firstTalk);
        dia =
          "???:Don't you have anything better to do than standing around and botherin' me?";
        return dia;
      }
    },
  },
...
const clickable = [
  {
    name: "mirror",
    desc: "Still got the same dead look in my eyes. It'd be nice if I left that back in Eastwyn.",
  },
  {
    name: "newspaper",
    desc: "Enough of that self-serving crap. Ain't helping my mood.",
  },
  {
    name: "bed",
    desc: "Middle class comfort? Maybe, but it's too gaudy for my tastes.",
  },
  {
    name: "luggage",
    desc: "Delayed indefinitely and only about four days worth of luggage. Just my luck.",
  },
  {
    name: "doorNum",
    desc: "Numbers with no real meaning._Besides telling me where I'm supposed to sleep, there's nothing else to figure out.",
  },
  {
    name: "carpet",
    desc: "Maybe the ship stopped cuz the crew’s just sittin’ somewhere, mesmerized by these godawful carpet patterns.",
  },
  {
    name: "elevator",
    desc: "Real pretty design. Hope it works better than the rest of this ship.",
  },
  {
    name: "elevatorB",
    desc: "Guess the workers don't deserve to look at the fancy door pattern.",
  },
  {
    name: "floatLights",
    desc: "The lights in there just float. I don't really understand how it works..",
  },
  {
    name: "Dine4Lamp",
    desc: "Tacky. That's the only polite way to put it honestly.",
  },
  {
    name: "Dine4Window",
    desc: "At least the view is nice to look at._No bullshit, no pomp...just the sea of stars out there.",
  },
  {
    name: "paperScrap",
  ...
  {
    name: "largeFloat",
    desc: "An artificial sea of stars...at least, that's what it looks like to me._Kinda embarrassing when the real deal is right outside the window.",
  },
  {
    name: "bigSky",
    desc: "...._Makes you realize all the shit down here doesn't matter much.",
  },
  {
    name: "umbrella",
    desc: "I'm sure they're nice to have on a day flight, but right now they're just taking up the view.",
  },
  {
    name: "poolSeat",
    desc: "I can imagine some pretty dames soaking up the sun on these things.",
  },
  {
    name: "brokenWall",
    desc: "The evidence of my dedication to seeing a case through to the end._Sounds better than tearing a hole in the wall for a damn piece of paper.",
  },
];
...
const item = [
  {
    name: "envelope",
    inInv: false,
    desc: "An envelope. It's sealed with wax and smells of cologne.",
  },
  {
    name: "crowbar",
    inInv: false,
    desc: "It's a crowbar...makes it easy to get into things that don't wanna open up.",
  },
  {
    name: "paperScrap",
    inInv: false,
    desc: "A half of a paper scrap. Might be important, might not be.",
  },
  {
    name: "paperFull",
    inInv: false,
    desc: "Well, it's a full note...but it might as well be in a different language.",
  },
];
